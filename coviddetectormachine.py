...
from gpiozero import PhaseEnableMotor # Enable pwm control via motor control libraly 
LED_bottom = PhaseEnableMotor(5,12,pwm=True,pin_factory=None) # Setting the pin configuretion 
LED_top = PhaseEnableMotor(13,19,pwm=True,pin_factory=None) # Setting the pin configuretion 

config_Data = {"Top_catesian":{'x':280,'y':650},"Bottom_catesian":{'x':200,'y':650}} #Configuretion data in json for the stepper motor control step co-ordination
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pushButton_20.clicked.connect(self.Restartprogram) #Restart program 
        ...
        self.dial1.setMaximum(100) # PWM output control function
        ...
        self.dial3.setMaximum(100) # PWM output control function
    ...
    def Restartprogram(self):
              ...
              run_restart = subprocess.check_output("sudo service supervisor restart",shell=True)
              print(run_restart)  
    def Rundetect(self):
    ...
    def Light_intense_top(self): 
          ...
          LED_top.forward(speed = self.dial1.value()*0.01)
    def Light_intense_bottom(self):
          ...
          LED_bottom.forward(speed = self.dial3.value()*0.01) 
          #spi = spidev.SpiDev()
          #spi.open(0,0)  
...
class Worker1(QThread):
    ...
    def run(self):
        ...
        try:
           ...
           print("Bottom camera not detected")
